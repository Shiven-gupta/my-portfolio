    ...
    <footer className="bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-12 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <a
            href="https://github.com/Shiven-gupta" target="_blank" className="flex items-center gap-2 hover:text-yellow-500 transition-colors" >
            <FaGithub /> github.com/Shiven-gupta
          </a>
          <a
            href="https://www.linkedin.com/in/gshiven-guptag/" target="_blank" className="flex items-center gap-2 hover:text-yellow-500 transition-colors" >
            <FaLinkedin /> linkedin.com/in/gshiven-guptag
          </a>
          <a href="https://www.hackerrank.com/profile/g_shivengupta_g" target="_blank" className="flex items-center gap-2 hover:text-yellow-500 transition-colors" >
